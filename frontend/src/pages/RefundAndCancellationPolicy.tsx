        ...
        <div className="max-w-4xl mx-auto space-y-16 animate-fade-up font-body text-base md:text-lg text-foreground/80 leading-relaxed">
          <section className="bg-muted/40 rounded-2xl p-8 shadow-sm">
            ...
            <ul className="space-y-3 list-disc pl-6">
              ...
              <li>
                ...
                <strong className="text-primary">50% credit</strong> that can be
                applied toward the next available class.
              </li>
              <li>
                The credit is valid for <strong>one class only</strong> and can
                be used once.
              </li>
              <li>
          ...
          <section className="bg-muted/40 rounded-2xl p-8 shadow-sm">
            ...
            <ul className="space-y-3 list-disc pl-6">
              ...
              <li>
                The advance may be <strong>adjusted to a new date</strong> only
                if cancellation is made within{" "}
                <strong className="text-primary">one week of payment</strong>.
              </li>
              <li>
                The revised booking must be scheduled within{" "}
                <strong className="text-primary">6 months</strong> of the
                original date, after which the amount will be forfeited.
              </li>
              <li>
                Rescheduled dates are subject to <strong>availability</strong>.
              </li>
              <li>
                Delays beyond <strong>30 minutes</strong> may impact the service
                timeline and are subject to feasibility.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-muted/40 rounded-2xl p-8 shadow-sm">
            ...
            <p className="mb-4">
              For cancellation, rescheduling, or refund requests, please contact
              us:
            </p>
          ...
          <p className="text-sm text-foreground/60 text-center">
            Meera Sakhrani Studio reserves the right to modify this policy at any
