import { Bell, Clock, Monitor, Phone } from "lucide-react";
...
const OnlinePaymentSection = ({ waitlistHref }: OnlinePaymentSectionProps) => {
  const classDetails = [
    ...
    <section id="enroll-online" className="py-16 md:py-24 lg:py-32 bg-[#F8F3EB]">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="bg-primary/5 p-8 md:p-12 border border-dusty-rose/30 text-center">
            <div className="w-20 h-20 bg-dusty-rose/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <Bell className="w-10 h-10 text-dusty-rose" />
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-dusty-rose/20">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-block w-full sm:w-auto rounded-full border border-primary/10 bg-primary px-8 py-4 font-sans text-sm tracking-[0.2em] uppercase text-primary-foreground transition-all duration-300 hover:bg-dusty-rose"
              >
                Join the Waitlist
              </a>
              <p className="mt-4 font-sans text-sm text-muted-foreground">
                No payment required {"\u2022"} We'll message you on WhatsApp
              </p>
              <p className="mt-2 font-sans text-sm text-muted-foreground/90">
                Be notified the moment applications open
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="p-6 bg-dusty-rose/10 border border-dusty-rose/20 text-center">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6 italic">
            We'll notify you the moment the next batch is announced.
          </p>
        </div>
      </div>
    </section>
