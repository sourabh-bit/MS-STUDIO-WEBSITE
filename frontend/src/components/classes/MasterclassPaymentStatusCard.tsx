      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto flex min-h-[68vh] max-w-5xl items-center justify-center">
          ...
          >
            ...
            {statusMessage && (
              <div className="mx-auto mt-4 max-w-md rounded-2xl border border-dusty-rose/20 bg-primary/[0.05] px-4 py-3 text-center font-sans text-sm leading-relaxed text-foreground/75">
                {statusMessage}
              </div>
            )}
